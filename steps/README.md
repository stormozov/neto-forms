...
![Steps](https://github.com/netology-code/ra16-homeworks/raw/ra-new/forms/steps/assets/steps.png)

Стили и пример разметки вы можете найти в папке [markup](https://github.com/netology-code/ra16-homeworks/tree/ra-new/forms/steps/markup). Разметка дана для примера, вы можете реализовать её самостоятельно
